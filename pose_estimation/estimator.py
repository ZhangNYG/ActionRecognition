    ...
    def draw_humans(npimg, humans, imgcopy=False):
        ...
        for human in humans:
            ...
            for i in range(common.CocoPart.Background.value):
                ...
                centers[i] = center
                cv2.circle(npimg, center, 2, common.CocoColors[i], thickness=3, lineType=8, shift=0)
            ...
            for pair_order, pair in enumerate(common.CocoPairsRender):
                ...
                npimg = cv2.line(npimg, centers[pair[0]], centers[pair[1]], common.CocoColors[pair_order], 2)
